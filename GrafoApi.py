...
# 		        print "opção inexistente"
		...
		grafo3.inserirAresta('------',0,'A','E')
		grafo3.inserirAresta('------',0,'A','S')
		grafo3.inserirAresta('------',0,'A','G')
		grafo3.inserirAresta('------',0,'A','L')
		grafo3.inserirAresta('------',0,'A','B')
		grafo3.inserirAresta('------',0,'B','J')
		grafo3.inserirAresta('------',0,'B','F')
		grafo3.inserirAresta('------',0,'B','R')
		grafo3.inserirAresta('------',0,'B','T')
		grafo3.inserirAresta('------',0,'B','S')
		grafo3.inserirAresta('------',0,'B','E')
		grafo3.inserirAresta('------',0,'C','I')
		grafo3.inserirAresta('------',0,'C','G')
		grafo3.inserirAresta('------',0,'D','L')
		grafo3.inserirAresta('------',0,'D','M')
		grafo3.inserirAresta('------',0,'D','R')
		grafo3.inserirAresta('------',0,'F','J')
		grafo3.inserirAresta('------',0,'F','S')
		grafo3.inserirAresta('------',0,'G','I')
		grafo3.inserirAresta('------',0,'H','P')
		grafo3.inserirAresta('------',0,'H','O')
		grafo3.inserirAresta('------',0,'H','N')
		grafo3.inserirAresta('------',0,'I','Q')
		grafo3.inserirAresta('------',0,'J','Q')
		grafo3.inserirAresta('------',0,'J','P')
		grafo3.inserirAresta('------',0,'K','M')
		grafo3.inserirAresta('------',0,'K','P')
		grafo3.inserirAresta('------',0,'L','R')
		grafo3.inserirAresta('------',0,'M','O')
		grafo3.inserirAresta('------',0,'N','R')
		grafo3.inserirAresta('------',0,'N','T')
		grafo3.inserirAresta('------',0,'N','P')
		grafo3.inserirAresta('------',0,'O','R')
		grafo3.inserirAresta('------',0,'P','T')
		grafoExemplo = grafo3.AEstrela('A','N')
		grafoExemplo.showGrafoTela()
		...
		# grafo5 = Grafo("Exemplo Coloração")
		# grafo5.criarVertice('A')
		# grafo5.criarVertice('B')
		# grafo5.criarVertice('C')
		# grafo5.inserirAresta('------', 4,'A','B')
		# grafo5.inserirAresta('------', 2,'A','C')
		# grafo5.coloreVertices()
